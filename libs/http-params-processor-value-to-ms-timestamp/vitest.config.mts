...
const project = 'libs/http-params-processor-value-to-ms-timestamp';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-to-ms-timestamp',
  test: {
    name: '@adaskothebeast/http-params-processor-value-to-ms-timestamp',
    watch: false,
    globals: true,
    environment: 'node',
