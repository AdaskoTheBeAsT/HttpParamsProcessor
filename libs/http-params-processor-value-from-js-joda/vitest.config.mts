...
const project = 'libs/http-params-processor-value-from-js-joda';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-from-js-joda',
  test: {
    name: '@adaskothebeast/http-params-processor-value-from-js-joda',
    watch: false,
    globals: true,
    environment: 'node',
