import { IValueFromStrategy, PeriodComponents } from '@adaskothebeast/http-params-processor-core';
import { Period } from '@js-joda/core';

/**
 * Strategy to normalize js-joda Period objects to PeriodComponents.
 */
export class JsJodaPeriodValueFromStrategy implements IValueFromStrategy<Period, PeriodComponents> {
