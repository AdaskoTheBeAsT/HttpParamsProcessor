...
import { LocalDate, LocalDateTime, ZonedDateTime, convert } from '@js-joda/core';
 ...
 */
export class JsJodaLocalDateValueFromStrategy implements IValueFromStrategy<JsJodaDateType, Date> {
