...
const project = 'libs/http-params-processor-value-to-date-fns';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-to-date-fns',
  test: {
    name: '@adaskothebeast/http-params-processor-value-to-date-fns',
    watch: false,
    globals: true,
    environment: 'node',
