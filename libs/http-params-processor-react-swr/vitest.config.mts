...
const project = 'libs/http-params-processor-react-swr';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-react-swr',
  resolve: {
    alias: {
  ...
  test: {
    name: '@adaskothebeast/http-params-processor-react-swr',
    watch: false,
    globals: true,
    environment: 'node',
