...
const project = 'libs/http-params-processor-react-tanstack-query';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-react-tanstack-query',
  resolve: {
    alias: {
  ...
  test: {
    name: '@adaskothebeast/http-params-processor-react-tanstack-query',
    watch: false,
    globals: true,
    environment: 'node',
