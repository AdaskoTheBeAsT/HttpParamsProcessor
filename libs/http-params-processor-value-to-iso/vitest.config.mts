...
const project = 'libs/http-params-processor-value-to-iso';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-to-iso',
  test: {
    name: '@adaskothebeast/http-params-processor-value-to-iso',
    watch: false,
    globals: true,
    environment: 'node',
