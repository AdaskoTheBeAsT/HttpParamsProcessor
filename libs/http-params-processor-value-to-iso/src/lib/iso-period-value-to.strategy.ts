import { IValueToStrategy, PeriodComponents } from '@adaskothebeast/http-params-processor-core';

/**
 * Strategy to serialize PeriodComponents to ISO 8601 period format.
 * Format: P[n]Y[n]M[n]W[n]D
 */
