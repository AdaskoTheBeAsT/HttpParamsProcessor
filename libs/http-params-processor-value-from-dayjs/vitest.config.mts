...
const project = 'libs/http-params-processor-value-from-dayjs';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-from-dayjs',
  test: {
    name: '@adaskothebeast/http-params-processor-value-from-dayjs',
    watch: false,
    globals: true,
    environment: 'node',
