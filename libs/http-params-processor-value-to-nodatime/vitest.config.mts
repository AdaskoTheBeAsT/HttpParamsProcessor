...
const project = 'libs/http-params-processor-value-to-nodatime';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-to-nodatime',
  test: {
    name: '@adaskothebeast/http-params-processor-value-to-nodatime',
    watch: false,
    globals: true,
    environment: 'node',
