...
const project = 'libs/http-params-processor-value-from-moment';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-from-moment',
  test: {
    name: '@adaskothebeast/http-params-processor-value-from-moment',
    watch: false,
    globals: true,
    environment: 'node',
