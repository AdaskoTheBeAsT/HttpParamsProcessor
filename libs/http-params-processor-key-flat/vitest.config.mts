...
const project = 'libs/http-params-processor-key-flat';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-key-flat',
  test: {
    name: '@adaskothebeast/http-params-processor-key-flat',
    watch: false,
    globals: true,
    environment: 'node',
