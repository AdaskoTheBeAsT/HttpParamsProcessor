...
const project = 'libs/http-params-processor-key-bracket-notation';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-key-bracket-notation',
  test: {
    name: '@adaskothebeast/http-params-processor-key-bracket-notation',
    watch: false,
    globals: true,
    environment: 'node',
