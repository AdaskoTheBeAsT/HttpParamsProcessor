...
const project = 'libs/http-params-processor-key-custom-delimiter';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-key-custom-delimiter',
  test: {
    name: '@adaskothebeast/http-params-processor-key-custom-delimiter',
    watch: false,
    globals: true,
    environment: 'node',
