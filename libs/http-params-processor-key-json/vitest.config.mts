...
const project = 'libs/http-params-processor-key-json';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-key-json',
  test: {
    name: '@adaskothebeast/http-params-processor-key-json',
    watch: false,
    globals: true,
    environment: 'node',
