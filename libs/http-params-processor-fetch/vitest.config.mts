...
const project = 'libs/http-params-processor-fetch';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-fetch',
  resolve: {
    alias: {
  ...
  test: {
    name: '@adaskothebeast/http-params-processor-fetch',
    watch: false,
    globals: true,
    environment: 'node',
