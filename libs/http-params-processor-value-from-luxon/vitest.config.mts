...
const project = 'libs/http-params-processor-value-from-luxon';
const reportPath = `../../.reports/${project}/`;

export default defineConfig(() => ({
  root: __dirname,
  cacheDir: '../../node_modules/.vite/libs/http-params-processor-value-from-luxon',
  test: {
    name: '@adaskothebeast/http-params-processor-value-from-luxon',
    watch: false,
    globals: true,
    environment: 'node',
